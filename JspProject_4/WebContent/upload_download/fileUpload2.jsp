...
<!-- 파일 이름 중복 처리를 위해 DefaultFileRenamePolicy 객체를 import 합니다. -->
...
<%
	...
	try{
		...
		- 네 번째 인자 "euc-kr" : 파일 이름이 한글은 경우 처리하는 부분입니다.
		- 다섯 번째 인자 : 똑같은 파일을 업로드 할 경우 중복되지 않도록 자동으로 파일 이름을 변환해주는 기능을 합니다.
		*/
...
<body>
	...
	<!-- 링크를 클릭했을 때 폼 영역의 데이터들을 filecheck.jsp 페이지로 전송 처리하는 부분입니다 -->
